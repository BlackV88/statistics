...
//In the image below are represented the distributions of the mean and the variance (in the two different histograms). In the image is also represented the mean and the variance of the samples and, below the second histogram, are written the mean and variance of the entire population.
namespace homework6
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            richTextBox3.Clear();
            richTextBox3.AppendText("Mean of the  population: " + population_expected_value.ToString().PadRight(50) + "\n");
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            richTextBox3.AppendText("Variance of the population: " + population_variance.ToString().PadRight(50));
